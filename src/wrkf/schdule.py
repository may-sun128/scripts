...
# First column represents hours 
# I did not need either of these two aforementioned datasets; I forgot how 2d arrays work 

schedule =  [['HR',  'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat',   'Sun'],
